    ...
    <section id="experience" className="scroll-mt-24 relative">
      ...
      >
        <h2 className="lg:hidden text-sm font-bold uppercase tracking-widest mb-6 flex items-center justify-between group/mobile">
          <ShinyText text="Experience" color="#9ca3af" shineColor="#e5e7eb" speed={3} delay={1.5} />
          {!isUntested && (
            <button
            ...
            return (
              ...
              >
                <BorderGlow
                  borderRadius={8}
                  glowRadius={20}
                  glowColor={isBugInteracting ? "0 80 60" : "210 80 60"}
                  colors={isBugInteracting ? ['#ef4444', '#f97316', '#dc2626'] : ['#3b82f6', '#6366f1', '#8b5cf6']}
                ...
                >
                  <a
                    ...
                    className="block p-4 sm:p-6 cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-primary"
                  >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start gap-2 mb-2">
                          <h3 className="text-base font-semibold group-hover:text-primary">
                            <ShinyText text={project.title} color="#d4d4d8" shineColor="#ffffff" speed={3} delay={1.5} />
